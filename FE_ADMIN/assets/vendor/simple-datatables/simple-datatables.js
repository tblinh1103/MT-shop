        ...
        1: [function (require, module, exports) {
            (function (global) {
                (function () {
                    ...
                    const i = t => ["#text", "#comment"].includes(t.nodeName) ? t.data : t.childNodes ? t.childNodes.map((t => i(t))).join("") : "",
                        n = t => {
                            if (null == t) return "";
                    ...
                    var R = {
                        ...
                        Y = function () {
                            ...
                            return t.prototype.init = function () {
                                ...
                                }(t, e, s), h = c.gaps1, u = c.gaps2, p = t.childNodes.slice(), m = e.childNodes.slice(), g = Math.min(h.length, u.length), b = [], v = 0, _ = 0; v < g; _ += 1, v += 1)
                                    if (!n || !0 !== h[v] && !0 !== u[v]) {
                                        if (!0 === h[_])
                                            ...
                                            nodeName: "#text",
                                            data: l.data
                                        }), g = Math.min(h.length, u.length)) : (b.push((new f).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, x(l))), h.splice(_, 0, !0), p.splice(_, 0, x(l)), g = Math.min(h.length, u.length));
                                        else if (h[_] !== u[v]) {
